...
{
    int Visual_range_x=atoi(argv[1]);
    int Visual_range_y=atoi(argv[2]);
    double R0=atof(argv[3]);
    double R1=atof(argv[4]);
    double mix_ratio_initial=atof(argv[5]);
    float alpha=atof(argv[6]);
    float beta=atof(argv[7]);
    int DDM=atoi(argv[8]);
    int chemotaxis=atoi(argv[9]);
    double migration_rate_r_mean=atof(argv[10]);
    double migration_rate_r_mean_quia=atof(argv[11]);
    double migration_rate_K_mean=atof(argv[12]);
    double deathjudge=atof(argv[13]);
    double time_interval=atof(argv[14]);
    int utralsmall=atoi(argv[15]); //1 yes, 0 no
    int allpng=atoi(argv[16]);
